...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12325 = 0;while(true){
if((i_12325 < arr.length))
{(arr[i_12325] = null);
{
...
{var i_12332 = (self__.level + 1);while(true){
if((i_12332 <= (new_level + 1)))
{(update[i_12332] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12334 = 0;while(true){
if((i_12334 <= self__.level))
{var links_12335 = (update[i_12334]).forward;if(((links_12335[i_12334]) === x__$1))
{(links_12335[i_12334] = (x__$1.forward[i_12334]));
{
var G__12336 = (i_12334 + 1);
i_12334 = G__12336;
continue;
}
} else
{{
var G__12337 = (i_12334 + 1);
i_12334 = G__12337;
continue;
}
}
